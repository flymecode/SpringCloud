...
package com.xupt.order.message;

import com.fasterxml.jackson.core.type.TypeReference;
import com.xupt.order.untils.JsonUtil;
...
public class ProductInfoReceiver {
	...
	private static final String PRODUCT_STOCK_TEMPLATE = "procduct_stock_%s";
	...
	public void process(String message) {
		...
		log.info("从对列【{}】接受到消息:{}","productInfo",productInfoOutputList);
		// 存储到redis中
